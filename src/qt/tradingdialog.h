...
private slots:
    ...
    void on_BuyFire_clicked();
    void on_SellFireBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputFire_textChanged(const QString &arg1);
    ...
    QString BuyFire(QString OrderType, double Quantity, double Rate);
    QString SellFire(QString OrderType, double Quantity, double Rate);
